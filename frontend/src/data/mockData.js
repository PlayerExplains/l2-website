/** Frontend fallback when the API is unreachable (tutorial demo mode). */
...
export const mockStats = {
  ...
  serverStatus: 'online',
  rates: { xp: 50, sp: 50, adena: 30, drop: 5, spoil: 5, enchant: 1, raidboss: 1, quest: 50, dualbox: 'Disabled' },
  nextSiege: {
    castleName: 'Giran',
